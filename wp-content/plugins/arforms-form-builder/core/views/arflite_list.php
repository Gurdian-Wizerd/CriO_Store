<?php
global $arfliteformhelper, $arflitemaincontroller;
$actions = array(
...
<div class="wrap arfforms_page">
		...
		<div id="post-body">
			<div class="wrap_content">
				...
				<div class="arflite_bulk_action-frm-wrap">
					<form method="get" id="arfmainformnewlist" class="data_grid_list" onsubmit="return arflite_apply_bulk_action_form();">
					<?php $arflite_page_chk = isset( $_GET['page'] ) ? esc_attr( sanitize_text_field($_GET['page']) ) : ''; ?>
						...
						<div class="footer_grid"></div>
							<?php do_action( 'arfliteafterlistingforms' ); ?>
					</form>
				</div>
	...
	?>
	<div class="documentation_link" align="<?php echo esc_attr( $doc_link_align ); ?>"><a class="doc-link-a" href="https://www.arformsplugin.com/documentation/1-getting-started-with-arforms/" target="_blank"><?php echo esc_html__( 'Documentation', 'arforms-form-builder' ); ?></a></div>
</div>
