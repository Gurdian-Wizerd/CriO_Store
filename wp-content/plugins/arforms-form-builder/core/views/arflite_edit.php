...
if ( $action == 'duplicate' || $action == 'edit' ) {
	$record = $wpdb->get_row( $wpdb->prepare( 'SELECT * FROM `' . $ARFLiteMdlDb->forms . '` WHERE id = %d', $arflite_id ) ); //phpcs:ignore
}
...
if ( ! empty( $record_arr ) ) {
	...
	$all_fields            = $wpdb->get_results( $wpdb->prepare( 'SELECT * FROM `' . $ARFLiteMdlDb->fields . '` WHERE form_id = %d ORDER BY ID ASC', $form_id ) ); //phpcs:ignore
}
...
$arfhttp_user_agent = isset( $_SERVER['HTTP_USER_AGENT'] ) ? $_SERVER['HTTP_USER_AGENT'] : '';
...
<style type="text/css" id="arf_form_other_css_<?php echo esc_attr( $arflite_id ); ?>">
	...
	if ( isset( $form_opts['arf_form_other_css'] ) ) {
		if ( $arfaction == 'new' || $arfaction == 'duplicate' ) {
			echo $temp_arf_form_other_css    = preg_replace( '/(-|_)(' . $define_template . ')/', '${1}' . esc_attr($arflite_id), esc_attr($form_opts['arf_form_other_css']), -1, esc_attr($count) ); //phpcs:ignore
...
<div class="arf_editor_wrapper">
	...
	<form action="" method="POST" id="arflite_current_form_export" name="arflite_current_form_export">
		<input type="hidden" name="s_action" value="arflite_opt_export_form" />
		<input type="hidden" name="arflite_opt_export" value="" />
	...
	<form name="arf_form" id="frm_main_form" method="post" onSubmit='return arflitemainformedit(0);'>
		...
		<?php 
			$arflitehttp_user_agent = isset( $_SERVER['HTTP_USER_AGENT'] ) ? $_SERVER['HTTP_USER_AGENT'] : '';
		...
		<div class="arf_editor_header_belt">
			<div class="arf_editor_header_inner_belt">
				...
				<div class="arf_editor_top_menu_button_wrapper">
							...
							<div class="arf_editor_form_shortcode_list_content">
								...
								<ul id="arf_editor_saved_form_shortcodes" class="arf_editor_form_shortcode_list <?php echo esc_attr( $arf_saved_form_shortcode ); ?>">
									...
									<li class="arf_editor_form_shortcode">
										...
										<span class="arf_shortcode_content">[ARFormslite id=<?php echo esc_html( $shortcode_form_id ); ?>]</span>
									</li>
									<li class="arf_editor_form_shortcode">
					...
					<button type="button" name="arf_cancel" class="arf_top_menu_cancel_button arfbelttooltip" onClick="window.location = '<?php echo esc_url( admin_url( 'admin.php?page=ARForms-Lite' ) ); ?>'" data-title="<?php echo esc_html__( 'Cancel', 'arforms-form-builder' ); ?>">
									...
									<div class="arf_accordion_container active">
										<div class="arf_input_style_container">
											...
											<div class="arf_accordion_container_row">
												<div class='arf_accordion_inner_title arf_width_50'><?php echo esc_html__( 'Input Style', 'arforms-form-builder' ); ?></div>
												<div class="arf_accordion_content_container arf_width_50 arf_right arfinputstyledrpdwn_container">
										...
										<div class="arf_color_scheme_container">
											...
											<div class="arf_accordion_container_row">
												<div class='arf_accordion_inner_title arf_custom_color_title'><?php echo esc_html__( 'Choose Color', 'arforms-form-builder' ); ?></div>
												<div class="arf_accordion_content_container arf_custom_color_div arf_right">
												...
												<div class="arf_customize_color_div arf_right">
													<div class="arf_customize_color_inner_label_div">
														<div class='arf_accordion_inner_title arf_label_custom_color arf_width_90'><?php echo esc_html__( 'Custom Color', 'arforms-form-builder' ); ?></div>
													</div>
										...
										<div class="arf_accordion_container_row">
											<div class='arf_accordion_inner_title arf_width_50'><?php echo esc_html__( 'Font Family', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_width_50 arf_right arfinputstyledrpdwn_container">
												<?php
													$fontsarr = array(
														'' => array(
										...
										<div class="arf_accordion_container_row arf_accordion_container_row_input_size" >
											<div class='arf_accordion_inner_title arfwidth40'><?php echo esc_html__( 'Input Field size', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arfwidth60 arf_accordion_container_mar">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Form Width', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container" style="<?php echo is_rtl() ? 'width:50%;' : 'width:58%;'; ?>" >
												<div class="arf_dropdown_wrapper">
													<?php
														...
														echo $arflitemaincontroller->arflite_selectpicker_dom( 'arffu', 'arffu', '', 'width:50px;', $newarr['form_width_unit'], $form_width_unit_attr, $form_width_unit_opts ); //phpcs:ignore
														?>
												</div>
												<input type="text" name="arffw" class="arf_small_width_txtbox arfcolor" data-arfstyle="true" data-arfstyledata='{"standard":".arflite_main_div_{arf_form_id}.arf_form_outer_wrapper~|~max-width{arf_form_width_unit}","material":".arflite_main_div_{arf_form_id}.arf_form_outer_wrapper~|~max-width{arf_form_width_unit}"}' data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_form_outer_wrapper" value="<?php echo esc_attr( $newarr['arfmainformwidth'] ); ?>" id="arf_form_width" onkeypress="return arflite_check_numeric_input(event,this)" />
											</div>
										...
										<div class="arf_accordion_container_row_separator"></div>
											<div class="arf_accordion_container_row arf_padding">
												...
												<div class="arf_accordion_container_row arf_half_width">
												<div class="arf_accordion_inner_title"><?php echo addslashes( esc_html__( 'Position', 'arforms-form-builder' ) ); //phpcs:ignore ?></div>
							...
							<dl class="arf_accordion_tab_form_settings">
								<dd>
									...
									<div class="arf_accordion_container">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text arf_width_50"><?php echo esc_html__( 'Display Title and Description', 'arforms-form-builder' ); ?></div>
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text"><?php echo esc_html__( 'Title Alignment', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_right arf_right arfinputstyledrpdwn_container">
										...
										<div class="arf_accordion_container_row arf_half_width">
											...
											<div class="arf_accordion_content_container arf_align_center arf_form_container arf_right arfformmarginvals arfinputstyledrpdwn_container">
												<span class="arfpxspan arfformarginvalpx">px</span>
												<div class="arf_form_margin_box_wrapper"><input type="text" name="arfformtitlepaddingsetting_1" id="arfformtitlepaddingsetting_1" onkeypress="return arflite_check_numeric_input(event,this)"  value="<?php echo esc_attr( $newarr['arfmainformtitlepaddingsetting_1'] ); ?>" data-arfstyle="true" data-arfstyledata='{"standard":".arflite_main_div_{arf_form_id} .allfields .arftitlediv~|~margin-top||.arflite_main_div_{arf_form_id} .arftitlecontainer~|~margin-top","material":".arflite_main_div_{arf_form_id} .allfields .arftitlediv~|~margin-top"}' class="arf_form_margin_box" data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_form_margin" /><br /><span class="arf_px arf_font_size arfformmarginleft"><?php echo esc_html__( 'Top', 'arforms-form-builder' ); ?></span></div>
												<div class="arf_form_margin_box_wrapper"><input type="text" name="arfformtitlepaddingsetting_2" id="arfformtitlepaddingsetting_2" onkeypress="return arflite_check_numeric_input(event,this)" value="<?php echo esc_attr( $newarr['arfmainformtitlepaddingsetting_2'] ); ?>" data-arfstyle="true" data-arfstyledata='{"standard":".arflite_main_div_{arf_form_id} .allfields .arftitlediv~|~margin-right","material":".arflite_main_div_{arf_form_id} .allfields .arftitlediv~|~margin-right"}' class="arf_form_margin_box" data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_form_margin" /><br /><span class="arf_px arf_font_size arfformmarginleft"><?php echo esc_html__( 'Right', 'arforms-form-builder' ); ?></span></div>
												<div class="arf_form_margin_box_wrapper"><input type="text" name="arfformtitlepaddingsetting_3" id="arfformtitlepaddingsetting_3" onkeypress="return arflite_check_numeric_input(event,this)" value="<?php echo esc_attr( $newarr['arfmainformtitlepaddingsetting_3'] ); ?>" data-arfstyle="true" data-arfstyledata='{"standard":".arflite_main_div_{arf_form_id} .allfields .arftitlediv~|~margin-bottom||.arflite_main_div_{arf_form_id} .arftitlecontainer~|~margin-bottom","material":".arflite_main_div_{arf_form_id} .allfields .arftitlediv~|~margin-bottom"}' class="arf_form_margin_box" data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_form_margin" /><br /><span class="arf_px arf_font_size arfformmarginleft"><?php echo esc_html__( 'Bottom', 'arforms-form-builder' ); ?></span></div>
												<div class="arf_form_margin_box_wrapper"><input type="text" name="arfformtitlepaddingsetting_4" id="arfformtitlepaddingsetting_4" onkeypress="return arflite_check_numeric_input(event,this)" value="<?php echo esc_attr( $newarr['arfmainformtitlepaddingsetting_4'] ); ?>" data-arfstyle="true" data-arfstyledata='{"standard":".arflite_main_div_{arf_form_id} .allfields .arftitlediv~|~margin-left","material":".arflite_main_div_{arf_form_id} .allfields .arftitlediv~|~margin-left"}' class="arf_form_margin_box" data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_form_margin" /><br /><span class="arf_px arf_font_size arfformmarginleft"><?php echo esc_html__( 'Left', 'arforms-form-builder' ); ?></span></div>
											</div>
											<?php
											$arfformtitlepaddingsetting_value = '';
										...
										<div class="arf_accordion_container_row arf_half_width arf_height_auto">
											<div class="arf_accordion_inner_title arf_two_row_text "><?php echo esc_html__( 'Background Image', 'arforms-form-builder' ); ?></div>
										...
										<div class="arf_accordion_container_row arf_half_width <?php echo esc_attr( $arf_bg_position_height_style_x ); ?>" id="arf_bg_img_position">
											<div class="arf_accordion_inner_title arf_bg_img_positionx-label arf_form_padding arf_two_row_text"><?php echo esc_html__( 'Background Image Position-X', 'arforms-form-builder' ); ?></div>
											<div class="arf_form_bg_position_container">
												...
												<div class="arf_dropdown_wrapper" style="width: 100%;">
													<?php
														...
														echo $arflitemaincontroller->arflite_selectpicker_dom( 'arf_bg_position_x', 'arf_bg_position_x', '', 'width:70%;margin-left: 15px;', $bg_position_selected_x, $bg_position_attr, $bg_position_opt ); //phpcs:ignore
														?>
													<span class="arf_px arf_font_size arfpxspan" style="margin-right:0;position: relative;"><?php echo addslashes( esc_html__( 'X-axis', 'arforms-form-builder' ) ); //phpcs:ignore ?></span>
												</div>  
											...
											<div class="arf_form_bg_position_input_container">
												<div class="arf_form_bg_position_input_div" id="arf_form_bg_position_input_div_x" style="<?php echo esc_attr( $arf_bg_position_style_x ); ?>">
													<span class="arf_px arf_font_size arfpxspan arf_margin-right0"><?php echo esc_html__( 'X-axis', 'arforms-form-builder' ); ?></span>
													<input type="text" name="arf_bg_position_input_x" id="arf_form_bg_position_input_x" value="<?php echo ( isset( $newarr['arf_bg_position_input_x'] ) && $newarr['arf_bg_position_input_x'] != '' ) ? esc_attr( $newarr['arf_bg_position_input_x'] ) : ''; ?>" class="arf_form_bg_position_input" onfocusout="arflite_set_form_bg_position(this, 'x', 'arf_fieldset_<?php echo esc_js( $arflite_id ); ?>')">
												</div>
											</div>
										</div>


										<div class="arf_accordion_container_row bg-img-posy-wrap arf_half_width <?php echo esc_attr( $arf_bg_position_height_style_y ); ?>">
											<div class="arf_accordion_inner_title arf_form_padding arf_two_row_text bg-img-posy-title"><?php echo esc_html__( 'Background Image Position-Y', 'arforms-form-builder' ); ?></div>
											...
											<div class="arf_form_bg_position_container">
												<div class="arf_dropdown_wrapper" style="width: 100%;">
													...
													if ( isset( $newarr['arf_bg_position_y'] ) && $newarr['arf_bg_position_y'] != '' ) {
														...
														echo $arflitemaincontroller->arflite_selectpicker_dom( 'arf_bg_position_y', 'arf_bg_position_y', '', 'width:70%;margin-left:15px;', $bg_position_selected_y, $bg_position_attr, $bg_position_opt ); //phpcs:ignore
														?>
													<span class="arf_px arf_font_size arfpxspan" style="margin-right:0;position: relative;"><?php echo addslashes( esc_html__( 'Y-axis', 'arforms-form-builder' ) ); //phpcs:ignore ?></span>
												</div>
											</div>
											...
											<div class="arf_form_bg_position_input_container">
												<div class="arf_form_bg_position_input_div" id="arf_form_bg_position_input_div_y" style="<?php echo esc_attr( $arf_bg_position_style_y ); ?>">
													<span class="arf_px arf_font_size arfpxspan arf_margin-right0"><?php echo esc_html__( 'Y-axis', 'arforms-form-builder' ); ?></span>
													<input type="text" name="arf_bg_position_input_y" id="arf_form_bg_position_input_y" value="<?php echo ( isset( $newarr['arf_bg_position_input_y'] ) && $newarr['arf_bg_position_input_y'] != '' ) ? esc_attr( $newarr['arf_bg_position_input_y'] ) : ''; ?>" class="arf_form_bg_position_input" onfocusout="arflite_set_form_bg_position(this, 'y', 'arf_fieldset_<?php echo esc_js( $arflite_id ); ?>')">
												</div>
											</div>
										</div>
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_form_padding arf_two_row_text"><?php echo esc_html__( 'Form Padding', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_frm_padding_options arf_align_center arf_form_container">
												<div class="arf_form_padding_box_wrapper"><input type="text" name="arfmainfieldsetpadding_1" id="arfmainfieldsetpadding_1" onkeypress="return arflite_check_numeric_input(event,this)" data-arfstyle="true" data-arfstyledata='{"standard":".arflite_main_div_{arf_form_id} .arf_fieldset~|~padding-top","material":".arflite_main_div_{arf_form_id} .arf_fieldset~|~padding-top"}' value="<?php echo esc_attr( $newarr['arfmainfieldsetpadding_1'] ); ?>" class="arf_form_padding_box" data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_form_padding" /><br /><span class="arf_px arf_font_size margin-left-10px"><?php echo esc_html__( 'Top', 'arforms-form-builder' ); ?></span></div>
												<div class="arf_form_padding_box_wrapper"><input type="text" name="arfmainfieldsetpadding_2" id="arfmainfieldsetpadding_2" onkeypress="return arflite_check_numeric_input(event,this)" value="<?php echo esc_attr( $newarr['arfmainfieldsetpadding_2'] ); ?>" data-arfstyle="true" data-arfstyledata='{"standard":".arflite_main_div_{arf_form_id} .arf_fieldset~|~padding-right","material":".arflite_main_div_{arf_form_id} .arf_fieldset~|~padding-right"}' class="arf_form_padding_box" data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_form_padding" /><br /><span class="arf_px arf_font_size margin-left-10px"><?php echo esc_html__( 'Right', 'arforms-form-builder' ); ?></span></div>
												<div class="arf_form_padding_box_wrapper"><input type="text" name="arfmainfieldsetpadding_3" id="arfmainfieldsetpadding_3" onkeypress="return arflite_check_numeric_input(event,this)" value="<?php echo esc_attr( $newarr['arfmainfieldsetpadding_3'] ); ?>" data-arfstyle="true" data-arfstyledata='{"standard":".arflite_main_div_{arf_form_id} .arf_fieldset~|~padding-bottom","material":".arflite_main_div_{arf_form_id} .arf_fieldset~|~padding-bottom"}' class="arf_form_padding_box" data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_form_padding" /><br /><span class="arf_px arf_font_size margin-left-10px"><?php echo esc_html__( 'Bottom', 'arforms-form-builder' ); ?></span></div>
												<div class="arf_form_padding_box_wrapper"><input type="text" name="arfmainfieldsetpadding_4" id="arfmainfieldsetpadding_4" onkeypress="return arflite_check_numeric_input(event,this)" value="<?php echo esc_attr( $newarr['arfmainfieldsetpadding_4'] ); ?>" data-arfstyle="true" data-arfstyledata='{"standard":".arflite_main_div_{arf_form_id} .arf_fieldset~|~padding-left||.arflite_main_div_{arf_form_id} .arf_inner_wrapper_sortable.arfmainformfield.ui-sortable-helper~|~left","material":".arflite_main_div_{arf_form_id} .arf_fieldset~|~padding-left||.arflite_main_div_{arf_form_id} .arf_inner_wrapper_sortable.arfmainformfield.ui-sortable-helper~|~left"}' class="arf_form_padding_box" data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_form_padding"data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_form_padding" /><br /><span class="arf_px arf_font_size margin-left-10px"><?php echo esc_html__( 'Left', 'arforms-form-builder' ); ?></span></div>
												<?php
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Border Type', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_right arf_right">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text"><?php echo esc_html__( 'Border Size', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_accordion_container_mar arf_align_center">
												<div class="arf_slider_wrapper">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text"><?php echo esc_html__( 'Border Radius', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_center arf_accordion_container_mar">
												<div class="arf_slider_wrapper">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text"><?php echo esc_html__( 'Window Opacity', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_center arf_accordion_container_mar">
												<div class="arf_slider_wrapper">
							...
							<dl class="arf_accordion_tab_input_settings">
								<dd>
									...
									<div class="arf_accordion_container">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_width_50"><?php echo esc_html__( 'Label Position', 'arforms-form-builder' ); ?></div>
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_width_50"><?php echo esc_html__( 'Label Align', 'arforms-form-builder' ); ?></div>
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text arf_width_50"><?php echo esc_html__( 'Label Width', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_right arf_width_50 arf_right">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text"><?php echo esc_html__( 'Hide Label', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_right">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_width_50"><?php echo esc_html__( 'Font Size', 'arforms-form-builder' ); ?></div>
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_width_50"><?php echo esc_html__( 'Text Alignment', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_width_50 arf_right">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Field Width', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arflite-field-width-con">
												<div class="arf_dropdown_wrapper">
													<?php
...
"><input type="radio" name="arftds" data-arfstyle="true" data-arfstyledata='{"standard":".arflite_main_div_{arf_form_id} input[type=text]:not(.inplace_field):not(.arf_field_option_input_text):not(.arf-select-dropdown):not(.arfslider):not(.arfhiddencolor):not(.arf_autocomplete)~|~direction||.arflite_main_div_{arf_form_id} input[type=text]:not(.inplace_field):not(.arf_field_option_input_text):not(.arfslider):not(.arfhiddencolor)~|~direction||.arflite_main_div_{arf_form_id} .arfdropdown-menu > li > a~|~text-align||.arflite_main_div_{arf_form_id} .bootstrap-select.btn-group .arfbtn .filter-option~|~text-align||.arflite_main_div_{arf_form_id} .autocomplete-content li span, .arflite_main_div_{arf_form_id} .autocomplete-content li~|~text-align||.arflite_main_div_{arf_form_id} .arf_fieldset .controls input[type=email]~|~direction||.arflite_main_div_{arf_form_id} .arf_fieldset .controls input[type=number]~|~direction||.arflite_main_div_{arf_form_id} .arf_fieldset .controls input[type=url]~|~direction||.arflite_main_div_{arf_form_id} .arf_fieldset .controls input[type=tel]~|~direction||~|~direction||.arflite_main_div_{arf_form_id} .arf_fieldset .controls textarea~|~direction||.arflite_main_div_{arf_form_id} .sltstandard_front .arf-selectpicker-control.arf_form_field_picker dt span~|~text-align||.arflite_main_div_{arf_form_id} .sltstandard_front .arf-selectpicker-control.arf_form_field_picker dd ul li~|~text-align","material":".arflite_main_div_{arf_form_id} .arf_materialize_form input[type=text]:not(.inplace_field):not(.arf_field_option_input_text):not(.arf-select-dropdown):not(.arfslider):not(.arfhiddencolor):not(.arf_autocomplete)~|~direction||.arflite_main_div_{arf_form_id} .arf_materialize_form input[type=text]:not(.inplace_field):not(.arf_field_option_input_text):not(.arfslider):not(.arfhiddencolor)~|~direction||.arflite_main_div_{arf_form_id} .arf_materialize_form .arf-select-dropdown li span~|~text-align||.arflite_main_div_{arf_form_id} .arf_materialize_form .autocomplete-content li span, .arflite_main_div_{arf_form_id} .arf_materialize_form .autocomplete-content li~|~text-align||.arflite_main_div_{arf_form_id} .arf_materialize_form .arf_fieldset .controls input[type=email]~|~direction||.arflite_main_div_{arf_form_id} .arf_materialize_form .arf_fieldset .controls input[type=number]~|~direction||.arflite_main_div_{arf_form_id} .arf_materialize_form .arf_fieldset .controls input[type=url]~|~direction||.arflite_main_div_{arf_form_id} .arf_materialize_form .arf_fieldset .controls input[type=tel]~|~direction||.arflite_main_div_{arf_form_id} .arf_materialize_form textarea:not(.html_field_description):not(.g-recaptcha-response):not(.wp-editor-area)~|~direction||.arflite_main_div_{arf_form_id} .sltstandard_front .arf-selectpicker-control.arf_form_field_picker dt span~|~text-align||.arflite_main_div_{arf_form_id} .sltstandard_front .arf-selectpicker-control.arf_form_field_picker dd ul li~|~text-align"}' data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_input_text_direction" class="visuallyhidden" value="0"  id="txt_dir_2" <?php checked( $newarr['text_direction'], 0 ); ?> /><svg width="25px" height="29px" viewBox="0 0 30 30"><path xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" fill="#bcc9e0" clip-rule="evenodd" d="M23.881,0.43v18.875h2V0.43H23.881z M8.819,4.867l-7.938,5l7.938,5v-3.5H21.89    v-3H8.819V4.867z"/></svg></label><br>
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text"><?php echo esc_html__( 'Field Transparency', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text"><?php echo esc_html__( 'Hide Required Indicator', 'arforms-form-builder' ); ?></div>
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text arf_width_50"><?php echo esc_html__( 'Space Between Two Fields', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_width_50 arf_right arfinputstyledrpdwn_container">
												<input type="text" name="arffms" id="arffieldmarginsetting" onkeypress="return arflite_check_numeric_input(event,this)" class="arf_small_width_txtbox arfcolor" data-arfstyle="true" data-arfstyledata='{"standard":".arflite_main_div_{arf_form_id} #new_fields .arfmainformfield.edit_form_item~|~field-margin-bottom","material":".arflite_main_div_{arf_form_id} #new_fields .arfmainformfield.edit_form_item~|~field-margin-bottom"}' data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_space_between_fields" value="<?php echo esc_attr( $newarr['arffieldmarginssetting'] ); ?>"  size="5" />
											</div>
										</div>
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Vertical', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_center arf_accordion_container_mar">
												<div class="arf_slider_wrapper">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Horizontal', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_center arf_accordion_container_mar">
												<div class="arf_slider_wrapper">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Border Size', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_center arf_accordion_container_mar">
												<div class="arf_slider_wrapper">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Date Format', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title"><?php echo addslashes( esc_html__( 'Add Timer', 'arforms-form-builder' ) ); //phpcs:ignore ?>
											</div>
											<div class="arf_float_right arfmarginright4">
												<label class="arf_js_switch_label">
											...
											<div class="arf_accordion_container_row arf_half_width" id="arfpagebreak_settimeron" 
											<?php
											if ( isset( $newarr['arfsettimer'] ) && $newarr['arfsettimer'] == 0 ) {
												?>
										...
										?>
										<div class="arf_accordion_container_row arf_half_width" id="showunits_breakfield" 
										<?php
										if ( isset( $newarr['arfsettimer'] ) && $newarr['arfsettimer'] == 0 ) {
											?>
											 style="display: none;" <?php } ?> >
											<div class="arf_accordion_inner_title arf_two_row_text"><?php echo addslashes( esc_html__( 'Show Units', 'arforms-form-builder' ) ); //phpcs:ignore ?></div>
											<div class="arf_accordion_content_container arf_align_right arf_right">         
										...
										if ( isset( $newarr['arfsettimer'] ) && $newarr['arfsettimer'] == 0 ) {
											...
											<div class="arf_accordion_content_container arf_align_right arf_right">
												...
												<div class="arf_form_timer_val_wrapper"><input type="text" name="arfaddtimerbreakfieldmin" id="arfaddtimerbreakfieldmin" value="<?php echo isset( $newarr['arfaddtimerbreakfieldhrs'] ) ? esc_attr( $newarr['arfaddtimerbreakfieldmin'] ) : ''; ?>"  class="arf_form_padding_box arf_input_unitmin arf_total_unit_check arf_unit_reset_field arf_restricted_control"  
																																														   <?php
																																															if ( in_array( 'min', $check_timer_attr ) ) {
																																																?>
													 enabled="enable" 
																																																<?php
																																															} else {
										...
										<div class="arf_accordion_container_row arf_half_width" id="arfstarttimerpg_no" 
										<?php
										if ( isset( $newarr['arfsettimer'] ) && $newarr['arfsettimer'] == 0 ) {
											?>
											 style="display: none; <?php } ?>"> 
											<div class="arf_accordion_inner_title arf_two_row_text arf_width_50"><?php echo esc_html__( 'Start timer on page no.', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_right arf_width_50 arf_right arf_restricted_control" id="arf_startpgno">
												<?php
										...
										<div class="arf_accordion_container_row arf_half_width" id="arfendtimerpg_no" 
										<?php
										if ( isset( $newarr['arfsettimer'] ) && $newarr['arfsettimer'] == 0 ) {
											?>
											 style="display: none; <?php } ?>"> 
											<div class="arf_accordion_inner_title arf_two_row_text arf_width_50"><?php echo esc_html__( 'End timer on page no.', 'arforms-form-builder' ); ?>
											</div>

											<div class="arf_accordion_content_container arf_align_right arf_width_50 arf_right arf_restricted_control" id="arfsettimeendpageno">
												<?php
										...
										<div class="arf_accordion_container_row arf_half_width arf_restricted_control" id="timerstyle" 
										<?php
										if ( isset( $newarr['arfsettimer'] ) && $newarr['arfsettimer'] == 0 ) {
											?>
											 style="display: none; <?php } ?>"> 
											<div class="arf_accordion_inner_title"><?php echo addslashes( esc_html__( 'Timer Style', 'arforms-form-builder' ) ); //phpcs:ignore ?></div>
											<div class="arf_accordion_content_container">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Style', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container">
												<div class="arf_dropdown_wrapper" style="margin-right: 5px;">
													<?php
							...
							<dl class="arf_accordion_tab_field_animation_settings arf_field_animation_main_container">
								<dd>
									...
									<div class="arf_accordion_container">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title"><?php echo addslashes( esc_html__( 'Animation', 'arforms-form-builder' ) ); //phpcs:ignore ?></div>
											<div class="arf_accordion_content_container">
												<?php
												...
												$no_animation = array(
													...
													echo $arflitemaincontroller->arflite_selectpicker_dom( 'arf_editor_form_width_unit', 'arf_editor_form_width_unit', 'arf_restricted_control arf_disabled', 'width:170px;', '', $ar_disable_animation, $no_animation ); //phpcs:ignore
												?>
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text arf_width_50"><?php echo esc_html__( 'Animation Duration', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_right arf_width_50 arf_right arf_restricted_control">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text arf_width_50"><?php echo esc_html__( 'Animation Delay', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_right arf_width_50 arf_right arf_restricted_control">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text"><?php echo esc_html__( 'Inherit', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_right">
										...
										<div class="arf_accordion_container_row arf_half_width">
											...
											<div class="arf_accordion_content_container">
												...
												$animation = array(
													...
													echo $arflitemaincontroller->arflite_selectpicker_dom( 'arf_editor_form_width_unit', 'arf_editor_form_width_unit', 'arf_restricted_control arf_disabled', 'width:170px;', '', '', $animation ); //phpcs:ignore
												?>
											</div>
										</div>
							...
							<dl class="arf_accordion_tab_submit_settings">
								<dd>
									...
									<div class="arf_accordion_container">
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text"><?php echo esc_html__( 'Button Width (optional)', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container">
												<span class="arfpxspan">px</span>
												<input type="text" name="arfsbws" id="arfsubmitbuttonwidthsetting" class="arf_small_width_txtbox arfcolor" onkeypress="return arflite_check_numeric_input(event,this)" value="<?php echo esc_attr( $newarr['arfsubmitbuttonwidthsetting'] ); ?>"  onchange="arflitesetsubmitwidth();" size="5" />
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text arf_width_50" ><?php echo esc_html__( 'Button Height (optional)', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_width_50">
												<span class="arfpxspan">px</span>
												<input type="text" name="arfsbhs" id="arfsubmitbuttonheightsetting" class="arf_small_width_txtbox arfcolor" data-arfstyle="true" data-arfstyledata='{"standard":".arflite_main_div_{arf_form_id} .arfsubmitbutton .arf_submit_btn~|~height","material":".arflite_main_div_{arf_form_id} .arfsubmitbutton .arf_submit_btn~|~height"}' data-arfstyleappend="true" data-arfstyleappendid="arf_{arf_form_id}_form_submit_button_height" onkeypress="return arflite_check_numeric_input(event,this)" value="<?php echo esc_attr( $newarr['arfsubmitbuttonheightsetting'] ); ?>"  size="5" />
											</div>
										</div>
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Button Text', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container">
												<?php
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_width_50"><?php echo esc_html__( 'Button Style', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_width_50 arf_right">
												<?php
													...
													echo $arflitemaincontroller->arflite_selectpicker_dom( 'arfsubmitbuttonstyle', 'arfsubmitbuttonstyle', '', '', $newarr['arfsubmitbuttonstyle'], $submit_button_style_attr, $submit_button_style_opts ); //phpcs:ignore
													?>
											</div>
										</div>
										<div class="arf_accordion_container_row arf_half_width" style="margin-bottom: 30px;">
											<div class="arf_accordion_inner_title arf_form_padding" id="arf_sub_btn_margin"><?php echo esc_html__( 'Margin', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_form_container ">
												<div class="arf_submit_margin_box_wrapper"><input type="text" name="arfsubmitbuttonmarginsetting_1" id="arfsubmitbuttonmarginsetting_1" onchange="arflite_change_field_padding('arfsubmitbuttonmarginsetting');" value="<?php echo esc_attr( $newarr['arfsubmitbuttonmarginsetting_1'] ); ?>" class="arf_submit_margin_box" /><br /><span class="arf_px arf_font_size" ><?php echo esc_html__( 'Top', 'arforms-form-builder' ); ?></span></div>
												<div class="arf_submit_margin_box_wrapper"><input type="text" name="arfsubmitbuttonmarginsetting_2" id="arfsubmitbuttonmarginsetting_2" value="<?php echo esc_attr( $newarr['arfsubmitbuttonmarginsetting_2'] ); ?>" onchange="arflite_change_field_padding('arfsubmitbuttonmarginsetting');" class="arf_submit_margin_box" /><br /><span class="arf_px arf_font_size" ><?php echo esc_html__( 'Right', 'arforms-form-builder' ); ?></span></div>
												<div class="arf_submit_margin_box_wrapper"><input type="text" name="arfsubmitbuttonmarginsetting_3" id="arfsubmitbuttonmarginsetting_3" value="<?php echo esc_attr( $newarr['arfsubmitbuttonmarginsetting_3'] ); ?>" onchange="arflite_change_field_padding('arfsubmitbuttonmarginsetting');" class="arf_submit_margin_box" /><br /><span class="arf_px arf_font_size" style="    margin-left: 5px;"><?php echo esc_html__( 'Bottom', 'arforms-form-builder' ); ?></span></div>
												<div class="arf_submit_margin_box_wrapper"><input type="text" name="arfsubmitbuttonmarginsetting_4" id="arfsubmitbuttonmarginsetting_4" value="<?php echo esc_attr( $newarr['arfsubmitbuttonmarginsetting_4'] ); ?>" onchange="arflite_change_field_padding('arfsubmitbuttonmarginsetting');" class="arf_submit_margin_box" /><br /><span class="arf_px arf_font_size" style="margin-left: 10px;"><?php echo esc_html__( 'Left', 'arforms-form-builder' ); ?></span></div>
											</div>
											<?php
										...
										<div class="arf_accordion_container_row arf_half_width">
											<div class="arf_accordion_inner_title arf_two_row_text "><?php echo esc_html__( 'Background Hover Image', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_right arf_right">
										...
										<div class="arf_accordion_container_row arf_half_width arf_accordion_container_mar">
											<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Size', 'arforms-form-builder' ); ?></div>
										...
										<div class="arf_accordion_container_row arf_half_width arf_accordion_container_mar">
											<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Radius', 'arforms-form-builder' ); ?></div>
											<div class="arf_accordion_content_container arf_align_center">
												<div class="arf_slider_wrapper">
								...
								<div class="arf_accordion_container_row_separator"></div>
									...
									<div class="arf_accordion_container_row arf_half_width arf_accordion_container_mar">
										<div class="arf_accordion_inner_title"><?php echo esc_html__( 'X-offset', 'arforms-form-builder' ); ?></div>
										<div class="arf_accordion_content_container arf_align_center">
											<div class="arf_slider_wrapper">
									...
									<div class="arf_accordion_container_row arf_half_width arf_accordion_container_mar">
										<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Y-offset', 'arforms-form-builder' ); ?></div>
										<div class="arf_accordion_content_container arf_align_center">
											<div class="arf_slider_wrapper">
										...
										<div class="arf_accordion_container_row arf_half_width arf_accordion_container_mar">
										<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Blur', 'arforms-form-builder' ); ?></div>
										<div class="arf_accordion_content_container arf_align_center">
											<div class="arf_slider_wrapper">
									...
									<div class="arf_accordion_container_row arf_half_width arf_accordion_container_mar">
										<div class="arf_accordion_inner_title"><?php echo esc_html__( 'Spread', 'arforms-form-builder' ); ?></div>
										<div class="arf_accordion_content_container arf_align_center">
											<div class="arf_slider_wrapper">
				...
				<div class="arf_popup_content_container arf_mail_notification_container">
					...
					<div class="arf_popup_checkbox_wrapper arfemail-notify-wrap">
						...
						<div class="arf_custom_checkbox_div">
						 ...
						 <div style="<?php echo ( is_rtl() ) ? 'float: left;' : 'float: right;'; ?>">
							<a href="https://www.arformsplugin.com/documentation/email-notification" target="_blank" title="Help" class="fas fa-life-ring arf_adminhelp_icon arfhelptip tipso_style" data-tipso="Help"></a>
						</div>
					</div>
					...
					<div class="arf_auto_responder_content arfmarginl10" >
						<div class="arf_auto_responder_row">
							<div class="arf_auto_responder_column">
								...
								echo $arflitemaincontroller->arflite_selectpicker_dom( 'options[ar_email_to]', 'options_ar_user_email_to', $arf_autoresponder_cls, 'width:80%;margin-top: 7px;', $ar_email_to_val, $ar_email_to_attr, $selectbox_field_options, false, array(), $ar_email_to_opt_disable, array(), false, array(), true, 'arf_email_field_dropdown' ); //phpcs:ignore
						...
						<div class="arf_auto_responder_row">
							<div class="arf_auto_responder_column">
								...
								<input type="text" id="options_ar_user_from_name" name="options[ar_user_from_name]" value="<?php echo ( !empty( $values['ar_user_from_name'] ) && esc_attr($values['ar_user_from_name']) != '' ) ? esc_attr( $values['ar_user_from_name'] ) : esc_attr( $arflitesettings->reply_to_name ); ?>" <?php echo ( isset( $values['auto_responder'] ) && $values['auto_responder'] < 1 ) ? ' disabled="disabled" ' : ''; //phpcs:ignore ?> >
							</div>
							...
							<div class="arf_auto_responder_column">
								...
								if ( $ar_user_from_email == '' ) {
									$ar_user_from_email = $arflitesettings->reply_to;
								} else {
						...
						<div class="arf_auto_responder_row">
							<div class="arf_auto_responder_column">
								...
								if ( $ar_user_nreplyto_email == '' ) {
									$ar_user_nreplyto_email = $arflitesettings->reply_to_email;
								} else {
					...
					<div class="arf_admin_notification_content arfmarginl10" style="width:100%;">
						<div class="arf_auto_responder_row ">
							<div class="arf_auto_responder_column">
								...
								if ( $ar_admin_to_email == '' ) {
									$ar_admin_to_email = $arflitesettings->reply_to;
								} else {
						...
						<div class="arf_auto_responder_row">
							<div class="arf_auto_responder_column">
								<label class="arf_auto_responder_label_full"><?php echo esc_html__( 'From/Replyto Name', 'arforms-form-builder' ); ?></label>
								<input type="text" id="options_ar_admin_from_name" name="options[ar_admin_from_name]" value="<?php echo ( !empty( $values['ar_admin_from_name'] ) && esc_attr($values['ar_admin_from_name']) != '' ) ? esc_attr( $values['ar_admin_from_name'] ) : esc_attr( $arflitesettings->reply_to_name ); ?>" <?php echo esc_attr($chk_admin_notification_disabled); //phpcs:ignore ?> class="arf_advanceemailfield" >
							...
							<div class="arf_auto_responder_column">
								...
								if ( $ar_admin_from_email == '' ) {
									$ar_admin_from_email = $arflitesettings->reply_to;
								} else {
						...
						<div class="arf_auto_responder_row">
							<div class="arf_auto_responder_column">
								...
								if ( $ar_admin_reply_to_email == '' ) {
									$ar_admin_reply_to_email = $arflitesettings->reply_to_email;
								} else {
				...
				<div class="arf_popup_content_container arf_submit_action_container">
					...
					<p class="arftitle_p">
						...
						<label class="arfsub-action-msg">
							<a href="https://www.arformsplugin.com/documentation/form-submit-action/" target="_blank" title="Help" class="fas fa-life-ring arf_adminhelp_icon arfhelptip tipso_style" data-tipso="Help"></a>
						</label>
					</p>
