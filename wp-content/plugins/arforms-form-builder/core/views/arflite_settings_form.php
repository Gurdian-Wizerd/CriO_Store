...
<div class="wrap arf_setting_page">
	...
	<div id="poststuff" class="metabox-holder">
		...
		<div id="post-body">
			...
			<div class="inside arfwhitebackground">
				...
				<div class="formsettings1 arfwhitebackground">
					...
					<div class="setting_tabrow">
						...
						<div class="arftab" id="arftab">
							...
							<ul id="arfsettingpagenav" class="arfmainformnavigation">
								...
								?>
								">
									<a href="javascript:arflite_show_form_settimgs('general_settings','autoresponder_settings');"><?php echo esc_html__( 'General Settings', 'arforms-form-builder' ); ?></a>
								</li>
								...
								?>
								">
									<a href="javascript:arflite_show_form_settimgs('autoresponder_settings','general_settings');"><?php echo esc_html__( 'Email Marketing Tools', 'arforms-form-builder' ); ?><span class="arflite_pro_version_notice arflite_pro_notice_with_title">(Premium)</span></a>
								</li>
					...
					<input type="hidden" name="arflite_validation_nonce" id="arflite_validation_nonce" value="<?php echo esc_attr( wp_create_nonce( 'arflite_wp_nonce' ) ); ?>" />
						...
						<input type="hidden" name="arfcurrenttab" id="arfcurrenttab" value="<?php echo esc_attr(get_option( 'arflite_current_tab' )); ?>" />
							...
							<table class="form-table">
								...
								?>
								 >
									...
									<td valign="top" class="email-setting-input-td">
										<input type="button" value="<?php echo esc_html__( 'Send test mail', 'arforms-form-builder' ); ?>" class="rounded_button arf_btn_dark_blue send-testmail-input <?php echo esc_attr($smtp_test_main_class); ?>" id="arf_send_test_mail" <?php echo esc_attr($smtp_test_mail_style); ?>> <img alt='' src="<?php echo esc_url(ARFLITEIMAGESURL) . '/ajax_loader_gray_32.gif'; ?>" id="arf_send_test_mail_loader" width="16" height="16" /> <span  class="lblnotetitle">(<?php echo esc_html__( 'Test e-mail works only after configure SMTP server settings', 'arforms-form-builder' ); ?>)</span>
									</td>
								</tr>
								<tr class="arfmainformfield" valign="top">
									<td colspan="2"><div class="dotted_line dottedline-width96"></div></td>
								...
								<tr class="arfmainformfield" valign="top">
									<td class="tdclass">
										<label class="lblsubtitle"><?php echo esc_html__( 'Decimal separator', 'arforms-form-builder' ); ?></label>
								...
								<tr>
									...
									<td valign="top" class="email-setting-input-td"><div class="arf_gloabal_css_wrapper"><textarea name="arf_global_css" id="arf_global_css" class="txtmultinew"><?php echo stripslashes_deep( get_option( 'arflite_global_css' ) ); //phpcs:ignore ?></textarea></div></td>
				...
				<tr id="aweber_api_tr2" >
					...
					<td style="padding-left: 4px;">
						...
						<span id="aweber_link"><a href="javascript:void(0);" class="arlinks arf_restricted_control"><?php esc_html_e('Get Authorization Code','arforms-form-builder'); ?></a></span>
						<input type="hidden" name="aweber_status" id="aweber_status" value="<?php echo $aweber_data->is_verify; //phpcs:ignore ?>" />
				...
				<table class="wp-list-table widefat post arflite-email-marketer-tbl">
					...
					<tr id="icontact_api_tr2">
						...
						<td class="arficontact-username-td"><input type="text" name="icontact_username" class="txtmodal1" id="icontact_username" onkeyup="arflite_show_verify_btn('icontact');" size="80" value="" />
							<div class="arferrmessage display-none-cls" id="icontact_username_error"><?php echo esc_html__( 'This field cannot be blank.', 'arforms-form-builder' ); ?></div></div></td>
				...
				<table class="wp-list-table widefat post arflite-email-marketer-tbl">
					...
					<tr>
						<th class="email-marketer-img-th" width="18%">&nbsp;</th>
						<th class="email-marketer-img-wrapth" colspan="2"><img alt='' src="<?php echo esc_url(ARFLITEURL); ?>/images/madmimi.png" align="absmiddle" /></th>
					...
					<div class="arf_radio_wrapper">
						...
						<span>
							<label for="madmimi_1"><?php echo esc_html__( 'Using API', 'arforms-form-builder' ); ?></label>
						</span>
					</div>
					</th>
					...
					<tr id="madmimi_api_tr1" >
						...
						<td class="tdclass arfemail-marketer-credential-lbl"><label class="lblsubtitle"><?php echo esc_html__( 'Email Address', 'arforms-form-builder' ); ?></label></td>
						...
						<td class="arfemailinputtd"><input type="text" name="madmimi_email" class="txtmodal1" id="madmimi_email" size="80" onkeyup="arflite_show_verify_btn('madmimi');" value="" /> &nbsp; &nbsp;
							<div class="arferrmessage display-none-cls" id="madmimi_email_error"><?php echo esc_html__( 'This field cannot be blank.', 'arforms-form-builder' ); ?></div>
							<div class="arferrmessage display-none-cls" id="madmimi_email_not_valid_error"><?php echo esc_html__( 'Please enter valid email address.', 'arforms-form-builder' ); ?></div>
						</td>
					...
					<tr id="madmimi_api_tr2">
						...
						<td class="arfemailinputtd"><input type="text" name="madmimi_api" class="txtmodal1" id="madmimi_api" size="80" onkeyup="arflite_show_verify_btn('madmimi');" /> &nbsp; &nbsp;
							<span id="madmimi_link"><a href="javascript:void(0);" class="arlinks arf_restricted_control"><?php echo esc_html__( 'Verify', 'arforms-form-builder' ); ?></a></span>
							<span id="madmimi_loader" class="display-none-cls"><div class="arf_imageloader arfemailmarketerloaderdiv"></div></span>
							<span id="madmimi_verify" class="frm_verify_li display-none-cls"><?php echo esc_html__( 'Verified', 'arforms-form-builder' ); ?></span>
							<span id="madmimi_error" class="frm_not_verify_li display-none-cls"><?php echo esc_html__( 'Not Verified', 'arforms-form-builder' ); ?></span>
							<input type="hidden" name="madmimi_status" id="madmimi_status"/>
							<div class="arferrmessage display-none-cls" id="madmimi_api_error"><?php echo esc_html__( 'This field cannot be blank.', 'arforms-form-builder' ); ?></div></td>
			...
			<br />
			<p class="submit">
				<button class="rounded_button arf_btn_dark_blue general_submit_button gnral-save-changes-btn" type="submit" ><?php echo esc_html__( 'Save Changes', 'arforms-form-builder' ); ?></button></p>
			<br />
...
<div class="documentation_link" align="right"><a href="https://www.arformsplugin.com/documentation/1-getting-started-with-arforms/" class="arlinks" style="margin-right:10px;" target="_blank"><?php echo esc_html__( 'Documentation', 'arforms-form-builder' ); ?></a></div>
