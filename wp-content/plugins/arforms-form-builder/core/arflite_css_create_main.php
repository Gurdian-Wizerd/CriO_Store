...
global $arflitesettingcontroller,$arfliteformcontroller,$arflitesettings, $arflitefieldhelper, $arfliteform, $ARFLiteMdlDb;
...
$character_set = isset( $arflitesettings->arf_css_character_set ) && ! empty( $arflitesettings->arf_css_character_set ) ? (array) $arflitesettings->arf_css_character_set : array();
